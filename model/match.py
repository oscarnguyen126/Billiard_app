...
class Match(models.Model):
    ...
    formula = fields.Selection([('solo', 'Solo'), ('dual', 'Dual')], string=_('Competition format'), default='solo', required=True, tracking=True)
    playing_type = fields.Many2one('x.league.type', string=_('Playing type'), tracking=True)
